...
class _AdvisingScreen
{
	...
	function __construct($script_filename = "", FlightPath $flightpath = null, $screen_mode = "")
	{
		...
		$this->width_array = Array("1%", "0%","1%", "0%", "69%", "10%", "10%", "9%");
...
//CODE-DELETE-START -20170813 non subject row in advising screen, alignment with the subject row, changed code below
//CODE-REPLACED-BELOW
...
//CODE-DELETE-END
 ...
 //CODE-ADD-START -20170813 - Display course title by changes to original line below
     	...
     	<tr height='20' class='$hand_class $display_status'
      		...
      		<td align='left' width='$w2' class='tenpt underline' 
       		...
       		<td class='tenpt underline' $extra_style width='$w3' align='left' 
       			onClick='$js_code'>
        			$course_num&nbsp" . substr($crs_title,0,26) ."</td>
        	";
		if ($repeats > 0)
		{
			$pC .= "
